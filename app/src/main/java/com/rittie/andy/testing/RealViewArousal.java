...
public class RealViewArousal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nvBaselines:
                        Intent in4 = new Intent(RealViewArousal.this, BaselineSettings.class);
                        in4.putExtra("user", u);
                        startActivity(in4);
                        return true;
        ...
        int iAverageHR = c.getColumnIndex(DBAdapter.AVERAGE_HEART_RATE);
        for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
            if (c.getString(iBaselineName).equals("Resting")) {
                averageHR = c.getDouble(iAverageHR);
                break;
            }
        }
        db.close();
        ...
        tvBaseline.setText(String.valueOf(averageHR));
    ...
    private void appendToUI(final String string, final int code) {
        ...
        this.runOnUiThread(new Runnable() {
            ...
            double averageHeartRate = averageHR;
            double currentSum = 0;
