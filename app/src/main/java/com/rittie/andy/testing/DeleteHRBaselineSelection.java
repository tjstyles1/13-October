 ...
 */
public class DeleteHRBaselineSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_hr_baseline_selection);
        ...
        final ListView listView = (ListView) findViewById(R.id.hrBaselineListView);
        listView.setAdapter(itemsAdapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                final Baseline b = (Baseline) parent.getItemAtPosition(position);
                Intent in = new Intent(DeleteHRBaselineSelection.this, DeleteHeartRateSelection.class);
    ...
    protected void onResume() {
        ...
        ArrayAdapter<Baseline> itemsAdapter =
                new ArrayAdapter<Baseline>(this, android.R.layout.simple_list_item_1, baselines);
        ListView listView = (ListView) findViewById(R.id.hrBaselineListView);
        listView.setAdapter(itemsAdapter);
    }
